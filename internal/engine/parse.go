...
// ParsePage extracts links (with fragments and anchor text) and the set of
// element IDs/anchor names, which fragment validation checks against.
...
// normalizeURL canonicalizes a URL for deduplication: lowercased scheme/host,
// default ports and fragments stripped, empty path normalized to "/".
...
// isNonHTMLURL filters URLs that are almost certainly not crawlable HTML pages.
// They are still verified as links, just never enqueued for crawling.
